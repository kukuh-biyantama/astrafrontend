...
Route::middleware(['auth', 'role:user'])->group(function () {
    ...
    //post transaksi
    route::post('transaksi/addcart/', [UserController::class, 'transaksistore'])->name('transaksi.store');
    route::put('transaksi/books/rating/{id}', [UserController::class, 'storerating'])->name('rating.store');
});
